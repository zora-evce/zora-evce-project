    ...
    <body id="page-top">
        ...
        <section class="page-section" id="contact">
            <div class="container px-4 px-lg-5">
                <div class="row gx-4 gx-lg-5 justify-content-center mb-1">
                ...
                <div class="error-container">
                    <div class="error-content">
                        <i class="bi bi-qr-code-scan error-icon"></i>
                        <p>Continue with scan QR at charging station</p>
                        <button onclick="openCamera()" class="error-button">
                ...
                if (navigator.mediaDevices && navigator.mediaDevices.getUserMedia) {
                    ...
                    navigator.mediaDevices.getUserMedia({ video: { facingMode: 'environment' } })
                        .then(function(stream) {
                            // Camera opened successfully - QR scanning and redirection will be handled elsewhere
                            // Keep the stream running for QR scanning
                        })
