...
<html lang="en">
    <head>
        ...
        <title>Connector Not Active | Zora EVCE</title>
        <!-- Favicon-->
            ...
            <div class="container px-4 px-lg-5">
                ...
                <div class="error-container">
                    <div class="error-content">
                        <i class="bi bi-plug error-icon"></i>
                        <h1>Connector Cannot Be Used</h1>
                        <p>The selected connector currently is not available for charging due to inactive OR in used.</p>
                        @if(!empty($station_code) && !empty($connector_code))
                            <div class="error-meta">Station: {{ $station_code }} • Connector Number: {{ $connector_code }}</div>
                        @endif
                        <a href="{{ request()->fullUrl() }}" class="error-button">Try again</a>
                    </div>
                </div>
            </div>
        </section>
