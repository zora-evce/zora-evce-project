...
<head>
    ...
    <title>Connector Not Plugged In</title>
    <style>
...
<body>
    <div class="container">
        <h1>Connector Not Plugged In</h1>
        <p>Please plug the connector into your vehicle to proceed.</p>
        @if(!empty($station_code) && !empty($connector_code))
            <div class="meta">Station: {{ $station_code }} • Connector: {{ $connector_code }}</div>
        @endif
